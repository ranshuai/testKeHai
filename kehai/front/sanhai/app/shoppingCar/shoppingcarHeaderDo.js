define("shoppingcarHeaderDo",['common','dialogs','jquery_ui_min','base'],function(common,dialogs){
        ...
        if(schI_paget.sessionScope){
            $.ajax({
                ...
                success:function(data){
                    ...
                    $('#changeIdentity0').click(function(){ changeIdentity(0) });
                    $('#changeIdentity1').click(function(){ changeIdentity(1) });
                    $('#changeIdentity2').click(function(){ changeIdentity(2) });
                    $('#changeIdentity3').click(function(){ changeIdentity(3) });
