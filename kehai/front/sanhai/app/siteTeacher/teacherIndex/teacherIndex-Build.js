({
    ...
    modules: [
        {
            name: 'app/siteTeacher/teacherIndex/teacherIndex',
            include:['dialogs','money','base_dialog_standard','common','base','jquery_ui_min','app/siteTeacher/teacherHeader',"teacherIndexDo"]
        }
    ]
})
