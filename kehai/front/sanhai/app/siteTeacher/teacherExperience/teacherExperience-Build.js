({
    ...
    modules: [
        {
            name: 'app/siteTeacher/teacherExperience/teacherExperience',
            include:['jquery','dialogs','pageBar','base_dialog_standard','common','base','jquery_ui_min','app/siteTeacher/teacherHeader',"teacherExperienceDo"]
        }
    ]
})
