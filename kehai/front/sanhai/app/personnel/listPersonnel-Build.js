({
    ...
    modules: [
        {
            name: 'app/personnel/listPersonnel',
            include:[
                "jquery","common","pageBar","dialogs","qrcode","njs","jquery_md5",
                "jquery_validate","addkehai_validate","messages_zh",'module/sanhai_buttonCountdown',
                'app/personnel/listPersonnelDo'
            ]
        }
    ]
})
