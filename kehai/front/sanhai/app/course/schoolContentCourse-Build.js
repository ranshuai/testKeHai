...
({
    ...
    modules: [
        {
            name: 'app/course/schoolContentCourse',
            include:[
                'jquery','money','loadVersionAndMatch','loadAreaAndMatch','base_dialog_standard','sanhai-course-modify-standard-1.0.0','app/course/schoolContentCourseDo'
            ]
        }
    ]
})
