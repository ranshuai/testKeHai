...
({
    ...
    modules: [
        {
            name: 'app/course/teacherContentCourse',
            include:[
                'jquery','money','loadVersionAndMatch','loadAreaAndMatch','sanhai-course-modify-standard-1.0.0','app/course/teacherContentCourseDo'
            ]
        }
    ]
})
