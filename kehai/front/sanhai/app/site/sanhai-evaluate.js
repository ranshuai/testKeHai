...
define(['jquery','pageBar','common'],function($,pageBar,common){

   var loadevaluate1=function (url, data,currPage){
        var a = data;
    ...
    var loadstuevaluate1=function (url, data,currPage){
        var a = data;
        data += "currentPage=" + currPage;
        //console.log(a);
        //console.log(data)
    ...
    var loadShoolevaluate1=function (url, data,currPage){
        var a = data;
        data += "currentPage=" + currPage;
        //console.log(a);
        //console.log(data)
    ...
    var loadTeacherevaluate1=function (url, data,currPage){
        var a = data;
        data += "currentPage=" + currPage;
        //console.log(a);
        //console.log(data)
    ...
    var loadonetooneevaluate1=function (url, data,currPage,sercheEvaluate){
        var a = data;
        data += "currentPage=" + currPage;
        //console.log(a);
        //console.log(data)
    ...
    return {
        ...
        loadShoolevaluate1:loadShoolevaluate1,
        loadTeacherevaluate1:loadTeacherevaluate1,
        loadonetooneevaluate1:loadonetooneevaluate1
    }
});
