...
define([
    ...
    function ($, showSelectNav, loadHotCourse, sitePTCourseList,siteMainNav,siteSearchBar,siteTopBar,dialogs,intoPtCourse,jquery_ui_min) {
        ...
        soft = function (val) {
            if (val == 1) {//综合
                $("#sortType").val("100");
                sitePTCourseList.loadSelectPtCourse(1);
            }
            if (val == 2) {//人气
                $("#sortType").val("101");
                sitePTCourseList.loadSelectPtCourse(1);
        ...
        PTCourseListDo.prototype.init = function () {
        ...
        PTCourseListDo.prototype._init = function () {
            var t = this;
            t.init();
            new siteTopBar().render();
            sitePTCourseList.showSelectNav(sitePTCourseList.loadSelectPtCourse)
            //sitePTCourseList.loadSelectPtCourse(1);
            loadHotCourse.loadHotCourse();
            new siteMainNav().render();
            new siteSearchBar().render();
        };
        PTCourseListDo.prototype.render = function () {
            this._init();
        };
      ...
      $('.login_border .login_main_l_nav').delegate('.main_l_nav .js-li a','click',function(){
         ...
         /*测试*/
          ...
          sitePTCourseList.loadSelectPtCourse(1,index,oignore);
       });
        //点击左右切换的箭头
