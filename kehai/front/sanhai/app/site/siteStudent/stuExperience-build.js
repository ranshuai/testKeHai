({
    ...
    modules: [
        {
            name: 'app/site/siteStudent/stuExperience',
            include:[
                'jquery',
                ...
                'common',
                'base',
                'app/site/siteStudent/studentIndexDo',

                'app/site/siteStudent/stuExperienceDo', 'app/siteTeacher/teacherHeaderDo','app/siteTeacher/teacherHeader'
            ]
        }
    ]
})
