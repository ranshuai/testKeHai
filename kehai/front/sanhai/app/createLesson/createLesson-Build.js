({
    ...
    modules: [
        {
            name: 'app/createLesson/createLesson',
            include:[
                'jquery','dialogs','common', 'umeditor_config','umeditor','jquery_ui_min','ztree', 'jquery.datetimepicker', 'kpTree',
                'app/createLesson/createLessonDo'
            ]
        }
    ]
})
