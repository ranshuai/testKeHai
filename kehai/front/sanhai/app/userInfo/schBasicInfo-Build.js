({
    ...
    modules: [
        {
            name: 'app/userInfo/schBasicInfo',
            include:[
                "jquery","common","loadAreaAndMatch",
                "birthday","lib/jquery_validate/jquery.validate.min","addkehai_validate","base","dialogs","basicSchool",
                "messages_zh",
                "app/userInfo/schBasicInfoDo"
            ]
        }
    ]
})
