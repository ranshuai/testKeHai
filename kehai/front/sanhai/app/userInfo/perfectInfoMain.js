requirejs.config({
    ...
    paths: {
        ...
        /* "additional-methods":"lib/jquery_validate/additional-methods",
         "jquery_validate": "lib/jquery_validate/jquery.validate",                       // 校验框架
    ...
    shim: {
        ...
        /* "addkehai_validate":['additional-methods'],
        ...
        "sanhai-base64": {
            exports: "sanhai-base64"
        },
        "sanhai-site-STC-standard-1.0.0": {
            deps: ["jquery"],
            exports: "sanhai-site-STC-standard-1.0.0"
        },
        "loadVersionAndMatch": {
            deps: ["jquery","jquery_iframe_transport"],
            exports: "loadVersionAndMatch"
        },
        'course_center': {
            deps: ["jquery", "loadVersionAndMatch", "pageBar", 'dialogs'],
            exports: "course_center"
        },
        'changeCourse': {
            deps: ["jquery"],
            exports: "changeCourse"
        },
        'angular': {
            exports: 'angular'
        },
...
require(["app/userInfo/headerDo", "app/userInfo/header_Do", "app/userInfo/menuDo", "jquery"],
    function (header, header_, menu, $) {
        var userIdDentity = $("body").attr("data");
        var moduleMain = $("body").attr("moduleMain");
        ...
        //console.log();
        // require(['app/assets/orgChargePassword']);
        require([moduleMain]);
