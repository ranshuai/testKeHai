...
define(['jquery','course-history-1.0','common'], function ($,history,common) {
    ...
    function initTeaCourseHistory() {
        ...
        $("button.pa").click(function () {
            ...
            history.ajax4CourseHistory(data, 1);
        });
    ...
    return {
        initTeaCourseHistory : initTeaCourseHistory,
