 ...
 * _change_teacher_agree(trueFn,falseFn)      换老师记录【同意、不同意】
...
define(function () {
	 ...
	 return {
		  ...
		  '_waitDialog': function(text, src) {
				...
				if ($('.establish_success_wait').length != 0) {
					 ...
					 $("<div class='eject_warpper_wait establish_success_wait'>" +
						  ...
						  "<img src='/front/sanhai/images/loading.gif' />" +
						  "</div>" +
		  ...
		  //激活视频卡
		  //'_activateVideoCard': function (trueFn, falseFn) {
		  //    var d = this._init();
		  //    d.addClass('activateVideoCard').attr({'title': '激活视频卡'});
		  //    d.find('p').append($(
		  ...
		  //        "<input type=\"radio\" id=\"radio1\" name=\"buy\" checked=\"checked\" />" +
		  //        "<label for=\"radio1\">购买视频卡（年卡）</label>"+
		  //        "</p>"+
		  //        "<p style=\"padding-left: 35px;\">"+
		  //        "<input type=\"radio\" id=\"radio2\" name=\"buy\" />" +
		  //        "<label for=\"radio2\">激活已有的视频卡</label>"+
		  //        "</p>"+
		  //        "</div>"
		  //    ));
		  //    //alert(isMoneyNumber("0.1"));
		  ...
		  '_activateVideoCard': function (cardFun, balanceFun, falseFn) {
				...
				d.find('p').append($(
					 ...
					 "<label for=\"radio1\">&nbsp;余额账户购买视频卡（200元/年）</label>" +
					 "</p>" +
					 "<p style=\"padding-left: 35px;\">" +
		  ...
		  '_cardVideoCard': function (trueFn, falseFn, content) {
				var d = this._init();
				d.addClass('_cardVideoCard').attr({'title': '激活视频卡'});
				d.find('p').append($(
					 "<div class=\"popbox_item\">" +
					 "<div class=\"form_list\">" +
					 "<div class=\"row\">" +
		  ...
		  '_balanceVideoCard': function (trueFn, falseFn) {
				var d = this._init();
				d.addClass('_balanceVideoCard').attr({'title': '激活视频卡'});
				d.find('p').append($(
					 "<div class=\"popbox_item\">" +
		  ...
		  '_subjectNumExChange': function (txt, tit, trueFn, falseFn) {
				var d = $('<div class="popBox show pushNotice">' +
					 '<div class="popCont sure_del">' +
					 '<div class="popbox_item">' +
					 '<p><span style=" display:inline-block;width:40px; height:40px; background:url(../sanhai/images/ico.png) no-repeat -320px -1000px; vertical-align:middle;"></span> 恭喜！您本次可兑换<span class="orange"><span class="exchange_num">2</span>张主听券</span>。</p>' +
					 '</div>' +
					 '</div>' +
					 '</div>').appendTo('body');
				d.addClass('confirm_dialog').attr({'title': tit});
